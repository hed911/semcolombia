...
class Institucion::TestsController < ApplicationController
  ...
  def search
    hash = {}
    hash[:institucion] = current_usuario.institucion
    ...
    hash_caso["caso_salud_publicas.entidad_prestadora_id"] = params[:entidad_prestadora_id] if !params[:entidad_prestadora_id].nil? && !params[:entidad_prestadora_id].empty?
